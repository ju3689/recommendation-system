...
restaurant_data = [['german', "Esther's German Saloon", '3', '3', '22 Teutonic Ave.'],
                   ...
                   ['vegetarian', 'Green Garden', '4', '2', '14 Elm Street'],
                   ['french', 'Le Petit Bistro', '5', '4', '27 Rue de Provence'],
                   ['african', 'Safari Grill', '3', '3', '42 Savanna Road'],
                   ['american', 'Star Burger', '4', '4', '16 Main Street'],
                   ['barbecue', 'Smokehouse BBQ', '5', '4', '36 Hickory Lane'],
                   ['czech', 'Prague Delight', '4', '3', '10 Bohemia Avenue'],
                   ['chinese', 'Golden Dragon', '4', '3', '50 Chinatown'],
                   ['thai', 'Thai Palace', '5', '4', '12 Lotus Lane'],
                   ...
                   ['north korean', 'Pyongyang Palace', '3', '3', '55 Juche Road'],
                   ['swedish', 'Swedish Delights', '4', '3', '29 Stockholm Avenue'],
                   ...
                   ['african', 'Savannah Spice', '4', '3', '31 Serengeti Road'],
                   ['american', 'Burger Joint', '4', '3', '13 Burger Avenue'],
                   ['barbecue', 'Grill Masters', '5', '4', '38 BBQ Lane'],
